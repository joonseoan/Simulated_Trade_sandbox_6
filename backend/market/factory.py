...
See planning/MARKET_DATA_DESIGN.md §9. Selection happens exactly once, in the
FastAPI lifespan. There is no runtime switching and no code outside this
function branches on MASSIVE_API_KEY.
"""
