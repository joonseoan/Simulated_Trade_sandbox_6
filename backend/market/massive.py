"""The Massive (formerly Polygon.io) REST market data provider.

See planning/MARKET_DATA_DESIGN.md §11 / planning/MASSIVE_API.md.
"""
...
class MassiveProvider(MarketDataProvider):
    ...
    async def get_prices(self, tickers: list[str]) -> dict[str, PriceTick]:
        ...
        if resp.status_code in (401, 403):
            ...
            # selection happens once at startup (see factory.py).
