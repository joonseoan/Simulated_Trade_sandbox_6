...
See planning/MARKET_DATA_DESIGN.md §5 / planning/MARKET_INTERFACE.md §4.
"""
...
class MarketDataProvider(abc.ABC):
    """Abstract market data source. `SimulatedProvider` and `MassiveProvider`
    both implement this and nothing else in the codebase is allowed to know
    which one is active (except to report `.source` in /api/health)."""
